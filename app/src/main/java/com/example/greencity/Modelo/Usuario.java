...
public class Usuario {
    ...
    public Usuario(long cod_usuario, String nom_usuario, String password, String nombres, String apellidos, String telefono, String correo, Bitmap foto, String latitud, String longitud, int cod_tipo_usuario) {
